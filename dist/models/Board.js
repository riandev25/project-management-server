...
const checklistItemsSchema = new mongoose_1.Schema({
    checklistItems: { type: [checklistItemSchema], required: true },
});
const checklistObjectSchema = new mongoose_1.Schema({
    id: { type: Number, required: true },
    title: { type: String, required: true },
    percentage: { type: Number, required: true },
    checklistItems: { type: [checklistItemSchema] },
});
exports.Board = mongoose_1.default.model('Board', checklistItemsSchema, 'board-name');
